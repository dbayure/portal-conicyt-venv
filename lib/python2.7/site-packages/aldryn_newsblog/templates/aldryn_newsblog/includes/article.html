...
<div class="panel-body">
    ...
    -->
        <div class="post-preview">
            ...
            <p class="post-meta">{{ article.publishing_date|date }}</p>
        </div>
        ...
        {% if article.tags %}
            <p>
                {% for tag in article.tags.all %}
                    <a class="page-link" href="{% namespace_url 'article-list-by-tag' tag=tag.slug namespace=namespace default='' %}">{{ tag.name }}</a>
                {% endfor %}
            </p>
        {% endif %}
